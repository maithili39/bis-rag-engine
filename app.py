...
st.markdown(
    ...
    "BIS SP 21 Dataset &nbsp;·&nbsp; RAG + Hybrid Search &nbsp;·&nbsp; "
    "<a href='https://github.com/maithili39/bis-rag-engine' "
    "style='color:#3a3a3a;text-decoration:none;' target='_blank'>github.com/maithili39/bis-rag-engine</a>"
    "</p>",
    unsafe_allow_html=True,
)
